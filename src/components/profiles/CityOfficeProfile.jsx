              ...
              <div className='col-md-12'>
                <div className='builder_data'>
                  <div className='builder-hdr'>
                    <h4 className='sect-title mb-4 mt-0'>City Office Profile</h4>
                    <div className='row align-items-center '>
                      <div className='col-md-6 mb-3'>
                        <div className='d-flex'>
                          <label>Franchise Name :</label><span><b>{user.city_office_name}</b></span>
                        </div>
                      </div>
                      <div className='col-md-6 mb-3 text-right d-flex justify-content-end'>
                        <div className='companylogo '>
                          <img src={user.office_head_profile} alt="logos" width={100} />
                        </div>
                      </div>
                  ...
                  <div className='builder-hdr'>
                    <h4 className='sect-title mb-4 mt-0'>Office Head</h4>
                    <div className='row align-items-center '>
                      <div className='col-md-6 mb-3'>
                        <div className='d-flex'>
                          <label>Name :</label> <span><b>Unimakler</b></span>
                        </div>
                      </div>
                      <div className='col-md-6 mb-3 text-right d-flex justify-content-end'>
                        {/* <div className='companylogo '>
...
export default CityOfficeProfile