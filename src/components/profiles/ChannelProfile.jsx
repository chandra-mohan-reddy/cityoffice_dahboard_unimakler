      ...
      <div className='mt-3'>
        ...
        <div className='row justify-content-center'>
          ...
          <div className='builder_data'>
                ...
                <h4 className='sect-title mb-4 mt-0'>Channel Partner Profile</h4> 
                  ...
                  <div className='d-flex'>
                    <label>Full Name :</label> <span><b>Unimakler</b></span>
                  </div>

                    </div>
                    <div className='col-md-6 mb-3 text-right'>
                    <div className='d-flex'>
                    <label>Date of Birth :</label> <span><b>12-01-2025</b></span>
                  </div>
                    </div>

                    <div className='col-md-12 mb-3'>
                  <div className='d-flex'>
                    <label>Campany Name :</label> <span><b>Terraterri</b></span>
                  </div>
                  </div>
                    <div className='col-md-12 mb-3'>
                  <div className='d-flex'>
                    <label>Address :</label> <span><b>Terraterri</b></span>
                  </div>
                  </div>
                    
                    <div className='col-md-12 mb-3'>
                      <h5>Channel Partner Preferred Loaction</h5>
                      </div>
                  ...
                  <div className='col-md-3 mb-3'>
                  <div className='d-flex'>
                    <label>Branch Office :</label> <span><b>India</b></span>
                  </div>
                  </div>
                  ...
                  <div className='col-md-12 mb-3'>
                      ...
                      <div className='col-md-6 mb-3'>
                 <div className='d-flex'>
                   <label>Primary Email :</label> <span><b>Unimakler</b></span>
                 </div>

                   </div>
                      <div className='col-md-6 mb-3'>
                 <div className='d-flex'>
                   <label>Secondary Email :</label> <span><b>Unimakler</b></span>
                 </div>

                   </div>
                      <div className='col-md-6 mb-3'>
                 <div className='d-flex'>
                   <label>Primary Phone :</label> <span><b>Unimakler</b></span>
                 </div>

                   </div>
                      <div className='col-md-6 mb-3'>
                 <div className='d-flex'>
                   <label>Secondary Phone :</label> <span><b>Unimakler</b></span>
                 </div>

                   </div>
                  <div className='col-md-12 mb-3'>
                      <h5>Channel Partner Tenure</h5>
                      </div>

                      <div className='col-md-6 mb-3 text-right'>
                    <div className='d-flex'>
                    <label>Start Date:</label> <span><b>12-01-2025</b></span>
                  </div>
                    </div>

                    <div className='col-md-6 mb-3 text-right'>
                    <div className='d-flex'>
                    <label>End Date :</label> <span><b>12-01-2025</b></span>
                  </div>
                    </div>
                  <div className='col-md-12 mb-3'>
                  ...
                  <div className='d-flex align-items-center'>
                    <label>Profile Image :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
                      ...
                      <div className='col-md-6 mb-3'>
                  <div className='d-flex align-items-center'>
                    <label>Bank Details :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
                      ...
                      <div className='col-md-6 mb-3'>
                  <div className='d-flex align-items-center'>
                    <label>RERA Registration Number :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
                      ...
                      <div className='col-md-6 mb-3'>
                  <div className='d-flex align-items-center'>
                    <label>Aadhar Number :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
                      ...
                      <div className='col-md-6 mb-3'>
                  <div className='d-flex align-items-center'>
                    <label>PAN Number :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
                      ...
                      <div className='col-md-6 mb-3'>
                  <div className='d-flex align-items-center'>
                    <label>GST Number :</label> <span>  <img src="/assets/images/logo.png" alt="logos" width={100} /></span>
