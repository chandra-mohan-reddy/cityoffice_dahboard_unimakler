       ...
       <div className="col-md-12">
         <div className="card">
           <div className="card-header">
             <h3 className="card-title">Ongoing Expos</h3>
           ...
           <div className="card-body">
             ...
             <tr >
                       ...
                       <td>02-02-2024</td>   
                       <td>03-02-2024 </td>   
                       <td> <Link to="/viewdetails" className='ml-2'><span className='sta_iconn'> <FaRegEdit />
                       </span></Link>
                        <Link to="/viewdetails"><span className='sta_iconn'><GoEye />
                       </span></Link> 
                       </td>    
           </tr>
