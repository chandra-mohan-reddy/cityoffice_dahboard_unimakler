...
function AddGenaralmanager({ ...props }) {
                ...
                <div className="col-md-12">
                  <div className="white-box block5-franchise-performance">
                    <div className="widget-header d-flex justify-content-between mb-3">
                      <h4 className="box-title">General Manager</h4>
                      <Button
                        variant="primary"
        ...
        <Offcanvas.Body>
          <div className="card p-4">
            <div className="card-header">
              <h3 className="card-title">{formState === 1 ? 'Edit' : 'Add'} General Executive</h3>
            </div>
 ...
 <div className="col-md-12">
                  <h5 className="asint">Assign City Office Manager <span className="req">*</span></h5>
                </div>
                <div className="col-md-6 mb-3">
                  <div class="form-floating">
                  <select class="form-select" name="project" >
                    <option value="default">Select City Office Manager</option>
                    <option value="138">BRIGADE</option>
                  </select>
                  </div>
                </div>
                <div className="col-md-12">
...
export default AddGenaralmanager;
