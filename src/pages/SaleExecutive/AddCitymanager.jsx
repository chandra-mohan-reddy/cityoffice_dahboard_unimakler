                ...
                <div className="col-md-12">
                  <div className="white-box block5-franchise-performance">
                    <div className="widget-header d-flex justify-content-between mb-3">
                      <h4 className="box-title">City Manager</h4>
                      <Button
                        variant="primary"
        ...
        <Offcanvas.Body>
          <div className="card p-4">
            <div className="card-header">
              <h3 className="card-title">{formState === 1 ? 'Edit' : 'Add'} City Manager</h3>
            </div>
