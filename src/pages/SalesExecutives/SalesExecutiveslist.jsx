                                ...
                                <div className="page-title-box d-flex align-items-center justify-content-between">
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            ...
                                            <li className="breadcrumb-item active">Sales Executive List</li>
                                        </ol>
                                    </div>
                                    <div className="page-title-right">
                                    </div>
                            ...
                            <div className="col-md-12">
                                <div className="card">
                                    <div className="card-header">
                                        <h3 className="card-title">Sales Executive List</h3>
                                        <div className="">
                                                    ...
                                                    {cityOfficeList.length > 0 ?
                                                        cityOfficeList.map((ele, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td><Link to='/saleexecutivesdetails'>View</Link></td>
                                                                <td>
                                                                    <i
